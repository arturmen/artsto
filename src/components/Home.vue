...
export default {
    ...
    data() {
        return {
            images: [
                // // {id: 1,url:"require('../assets/logo-artsto-dark.png')"},
                // {id: 2,url:"../assets/logo-artsto-dark.png"},
                // {id: 3,url:"../assets/logo-artsto-dark.png"},
                // //{id: 4,url:"../assets/logo-artsto-dark.png"},
                // {id: 5,url:"../assets/logo-artsto-dark.png"}
            ]
        }
    }
}
